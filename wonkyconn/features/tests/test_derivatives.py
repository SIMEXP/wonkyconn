...
from wonkyconn.features import derivatives
import pandas as pd
import numpy as np
import pytest
...
def _make_fake_timeseries_collection(extracted_path: Path, empty_file) -> None:
    """Make test data."""
    for i in range(10):
...
def test_load_valid_timeseries(tmp_path: Path) -> None:
